...
def buildDRSChannels(DRSBoards):
    """
    Return a list of DRS channels for Cer and Sci readout.
    """
    drs_channels = []
    for _, DRSBoard in DRSBoards.items():
        for iTowerX, iTowerY in DRSBoard.GetListOfTowers():
            for var in ["Cer", "Sci"]:
                ...
                drs_channels.append(channelName)
    return drs_channels

def buildDRSChannelsAmplified(run=316):
    """
    return a list of DRS channels with amplifiers
    """
    drs_amplified = []
    if run >= 1040:
        drs_amplified.append("DRS_Board1_Group0_Channel0")
        drs_amplified.append("DRS_Board1_Group0_Channel1")
    return drs_amplified
...
def buildTimeReferenceChannels(run=316):
    ...
    if run < 685:
        ...
        time_reference_channels.append("DRS_Board2_Group2_Channel8")
        time_reference_channels.append("DRS_Board2_Group3_Channel8")
        time_reference_channels.append("DRS_Board3_Group0_Channel8")
        time_reference_channels.append("DRS_Board3_Group1_Channel8")
        time_reference_channels.append("DRS_Board3_Group2_Channel8")
        time_reference_channels.append("DRS_Board3_Group3_Channel8")
        time_reference_channels.append("DRS_Board0_Group0_Channel8")
    elif run >= 1173:
        time_reference_channels.append("DRS_Board0_Group0_Channel8")
        time_reference_channels.append("DRS_Board0_Group1_Channel8")
        time_reference_channels.append("DRS_Board0_Group2_Channel8")
        time_reference_channels.append("DRS_Board0_Group3_Channel8")
        time_reference_channels.append("DRS_Board1_Group0_Channel8")
        time_reference_channels.append("DRS_Board1_Group1_Channel8")
        time_reference_channels.append("DRS_Board1_Group2_Channel8")
        time_reference_channels.append("DRS_Board1_Group3_Channel8")
        ...
        time_reference_channels.append("DRS_Board3_Group2_Channel8")
        time_reference_channels.append("DRS_Board3_Group3_Channel8")
        time_reference_channels.append("DRS_Board4_Group0_Channel8")
        time_reference_channels.append("DRS_Board4_Group1_Channel8")
        time_reference_channels.append("DRS_Board4_Group2_Channel8")
        time_reference_channels.append("DRS_Board4_Group3_Channel8")
        time_reference_channels.append("DRS_Board5_Group0_Channel8")
        time_reference_channels.append("DRS_Board5_Group1_Channel8")
        time_reference_channels.append("DRS_Board5_Group2_Channel8")
        time_reference_channels.append("DRS_Board5_Group3_Channel8")
        time_reference_channels.append("DRS_Board6_Group0_Channel8")
        time_reference_channels.append("DRS_Board6_Group1_Channel8")
        time_reference_channels.append("DRS_Board6_Group2_Channel8")
        time_reference_channels.append("DRS_Board6_Group3_Channel8")
        time_reference_channels.append("DRS_Board7_Group0_Channel8")
        time_reference_channels.append("DRS_Board7_Group1_Channel8")
        time_reference_channels.append("DRS_Board7_Group2_Channel8")
        time_reference_channels.append("DRS_Board7_Group3_Channel8")
    else:
        raise ValueError(
...
def mapDRSChannel2TriggerChannel(DRS_channel, run = 685):
    ...
    if run < 583:
        ...
        if board == "0": return "DRS_Board0_Group0_Channel8"
